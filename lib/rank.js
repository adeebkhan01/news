...
//
// A member from a broker-only source (mortgage-broker trade press, fetched
// specifically for this mode — see fetch.js's brokerOnly source flag) is
// strong relevance unconditionally, regardless of what the keyword regexes
// find: "AFG appoints new CFO" is a broker story by virtue of who published
// it, not because it happens to say "mortgage".
function brokerRelevance(members) {
  if (members.some(function (m) { return m.brokerOnly; })) return 2;
